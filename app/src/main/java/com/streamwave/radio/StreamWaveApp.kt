...
class StreamWaveApp : Application() {
    ...
    private suspend fun prepopulateIfNeeded() {
        ...
        listOf(
            ...
            OfficialStationEntity(4,"538 Dance Dept","https://playerservices.streamtheworld.com/api/livestream-redirect/TLPSTR08.mp3","https://www.538.nl","",3,"Nederland","Nederlands","538 Dance Department — de beste dance!",true,false,4,"ONLINE",n),
            OfficialStationEntity(5,"538 Non-Stop","https://playerservices.streamtheworld.com/api/livestream-redirect/TLPSTR09.mp3","https://www.538.nl","",1,"Nederland","Nederlands","538 Non-Stop — onafgebroken hits!",true,false,5,"ONLINE",n),
            OfficialStationEntity(6,"538 80s Hits","https://playerservices.streamtheworld.com/api/livestream-redirect/TLPSTR15.mp3","https://www.538.nl","",7,"Nederland","Nederlands","538 80s — de grootste 80s hits!",true,true,6,"ONLINE",n),
            ...
            OfficialStationEntity(12,"Veronica Rock","https://playerservices.streamtheworld.com/api/livestream-redirect/SRGSTR11.mp3","https://www.radioveronica.nl","",2,"Nederland","Nederlands","Veronica Rock — non-stop rock classics!",true,false,12,"ONLINE",n),
            OfficialStationEntity(13,"Veronica Top 1000","https://playerservices.streamtheworld.com/api/livestream-redirect/SRGSTR09.mp3","https://www.radioveronica.nl","",7,"Nederland","Nederlands","Veronica Top 1000 Allertijden!",true,false,13,"ONLINE",n),
            ...
            OfficialStationEntity(22,"NPO Radio 2","https://icecast.omroep.nl/radio2-bb-mp3","https://www.nporadio2.nl","",7,"Nederland","Nederlands","NPO Radio 2 — de beste muziek!",true,true,22,"ONLINE",n),
            ...
            OfficialStationEntity(31,"Joe FM (BE)","https://playerservices.streamtheworld.com/api/livestream-redirect/JOE.mp3","https://www.joe.be","",7,"België","Nederlands","Joe — 70s, 80s & 90s hits!",true,false,31,"ONLINE",n),
